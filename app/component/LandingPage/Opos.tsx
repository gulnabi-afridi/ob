...
const Opos = () => {
  return (
    <div className='w-full py-10 sm:mt-0 xsm:-mt-[4rem] sm:py-24 2xl:mt-[8rem] lg:py-36 relative z-50'>
            ...
            <div className='w-full justify-center items-center max-w-[550px] 3xl:max-w-[800px] flex flex-col gap-6'>
              ...
              >
                <div className='w-full flex md:justify-start justify-center items-center gap-4 sm:gap-4 mt-0 2xl:mt-4'>
                  <button className='px-[20px] 2xl:px-[25px] 3xl:px-[38px] sm:px-[24px] cursor-pointer hover:opacity-80 py-[10px] sm:py-[12px] 2xl:py-[16px] 3xl:py-[24px] bg-purple-1 text-[16px] sm:text-[18px] 3xl:text-[40px] 2xl:text-[24px] text-white-1 rounded-lg'>
                    Trade Now
                  </button>
                  <div className='gradient-wrapper rounded-lg !p-[1px] 2xl:!p-[2px] 3xl:!p-[4px]'>
                    <button className='px-[20px] 2xl:px-[25px] 3xl:px-[38px] borderGradient cursor-pointer sm:px-[24px] hover:opacity-80 rounded-lg 2xl:py-[16px] 3xl:py-[24px] py-[10px] sm:py-[12px] bg-transparent text-[16px] 3xl:text-[40px] 2xl:text-[24px] sm:text-[18px] text-white-1'>
                      Build With Us
                    </button>
                  </div>
                </div>

        ...
        <Fade duration={1200} triggerOnce className='w-full h-full'>
          <div className='w-full flex flex-col gap-5 justify-center items-center h-full'>
            <Zoom duration={1500} triggerOnce>
              <div className="w-full -mt-28 max-w-[300px] sm:max-w-[450px] md:max-w-[940px] 2xl:max-w-[1800px] 3xl:w-[2100px] 2xl:h-[800px] 3xl:h-[1200px] h-[300px] sm:h-[400px] md:h-[490px] bg-[url('/assets/heroShape.svg')] flex flex-col justify-center items-center bg-center bg-cover bg-no-repeat">
                <p className='text-[#E0C7FF] mt-[5rem] sm:mt-[9rem] 3xl:mt-[9rem] text-[16px] 2xl:text-[42px] 3xl:text-[65px] sm:text-[24px] md:text-[30px] font-semibold'>
                  OpenBook
                </p>

                <h1 className='text-[38px] sm:block hidden sm:text-[50px] md:text-[70px] lg:text-[96px] 2xl:text-[120px] 3xl:text-[160px] tracking-[4px] leading-[50px] sm:leading-[60px] md:leading-[90px] lg:leading-[120px] 3xl:leading-[180px] text-center font-bold font-terminaExtraBold text-white-1 mt-0 2xl:mt-3'>
            ...
            <Slide
              ...
              triggerOnce
            >
              <div className='w-full max-w-[300px] rounded-xl sm:max-w-[500px] md:max-w-[700px] 2xl:max-w-[900px] 3xl:max-w-[1300px] flex justify-center items-center gradient-wrapper '>
                <div className='w-full py-3 2xl:py-5 3xl:py-10 flex justify-center rounded-xl items-center gap-24 sm:gap-28 borderGradient'>
                  <div className='flex justify-center items-center flex-col gap-0'>
                    <p className='text-white-1 text-[20px] sm:text-[30px] md:text-[48px] 2xl:text-[60px] 3xl:text-[90px] font-terminaExtraDemi'>
                      $9.8M
                    </p>
                    <p className='text-[14px] sm:text-[16px] md:text-[18px] 2xl:text-[24px] font-normal 3xl:text-[34px] text-white-1/60'>
                      24H Volume
                    </p>
                  </div>
                  <div className='flex justify-center items-center flex-col gap-0'>
